...
#define BAUD_RATE 921600 //for CP2102 on ESP32 board
#define PIN_LED 2
...
inline void send_samples(void); //maybe this helps
...
inline void receive_sample() {
    ...
    //spiRec(spi_bytes + TIMESTAMP_SIZE_IN_BYTES + SAMPLE_NUMBER_SIZE_IN_BYTES, num_spi_bytes);
